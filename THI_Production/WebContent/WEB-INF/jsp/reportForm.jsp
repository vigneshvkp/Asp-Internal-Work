		          ...
		          <td style="padding:10px;" valign="top" width="100%">
					<div id="grid">
						<div id="gridheader">
							...
							<p>Welcome ${userDetail.userName}, Project Report Form</p>				
						</div>
						<div id="gridcontainer">
							<table class="border" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									<td align="center"> 
										<form:form method="post" commandName="auditForm" action="#" onsubmit="return false" id="auditForm"> 
											<table class="projectDet" width="100%" cellspacing="0">
												...
												<tr style="background: rgb(236, 239, 241);">	
													...
													<td align="left">
													    <form:input path="auditCycleDate" id="startDate" class="date-picker thiReportForm" />					    
													</td>
												</tr>
												<tr style="background: rgb(255, 254, 239);">	
													<td width="20%" align="right" ><input type="submit" value="&nbsp;Get Report&nbsp;" id="getAudit"/></td>
													<td>&nbsp;</td>							
												</tr>
											</table>
											<br />
