...
'#9A9A9A',	// BorderColor ('color')8F90C4
0,		// Padding
'#9A9A9A',	// Background ('color','transparent','[image_source]')CBCBEF
...
'#00afde',	// BorderColor ('color')FFF5C6
'#a2c654',	// OVER BorderColor4d4c76
5,		// Padding
'[../images/menu1_bg.gif]',	// Background ('color','transparent','[image_source]')FFF5C6
'#a2c654',	// OVER Background
'#ffffff',	// Color
'#ffffff',	// OVER Color
...
'#66c6dc',	// ItemsSeparatorColor ('color','transparent')
...
'#00afde',		// VISITED BorderColor
'[../images/menu1_bg.gif]',		// VISITED Background
...
1,		// BorderWidth
'solid',	// BorderStyle (CSS valid values except 'none')
'#b3c5db',	// BorderColor ('color')
0,		// Padding
'#f2f7fd',	// Background ('color','transparent','[image_source]')
'',		// IEfilter (only transition filters work well - not static filters)
''		// Custom additional CSS for the menu box (valid CSS)
],[
// MENU ITEMS STYLE
...
'solid',	// BorderStyle (CSS valid values except 'none')
'solid',	// OVER BorderStyle
'#f2f7fd',	// BorderColor ('color')
'#c5e189',	// OVER BorderColor
5,		// Padding
'#f2f7fd',	// Background ('color','transparent','[image_source]')
'#e0f6b1',	// OVER Background
'#333333',	// Color
'#000000',	// OVER Color
'11px',		// FontSize (values in CSS valid units - %,em,ex,px,pt)
'Tahoma',	// FontFamily
...
'solid',		// VISITED BorderStyle
'#f2f7fd',		// VISITED BorderColor
'#f2f7fd',		// VISITED Background
